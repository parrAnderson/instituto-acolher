...
<div>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4" v-if="selectGenero !== 'Outros'">
            ...
            <div class="col-10 col-xs-10 col-sm-10 col-md-3 col-lg-3" v-if="selectGenero == 'Outros'">
                <label for="">Gênero</label>
        ...
        <div class="row justify-content-center row-space-form">
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4" v-if="selectReligiao !== 'Outro'">
            ...
            <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-3" v-if="selectReligiao == 'Outro'">
                <label>Religião</label>
