...
<div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xs-8 col-sm-8 col-md-4 col-lg-4" v-if="selectGenero !== 'Outros'">
        ...
        <div class="row justify-content-center row-space-form">
            ...
            <div class="col-xs-8 col-sm-8 col-md-4 col-lg-4" v-if="selectReligiao !== 'Outro'">
            ...
            <div class="col-8 col-lg-3" v-if="selectReligiao == 'Outro'">
                <label>Religião</label>
