        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-10">
                <div v-if="atendimentos">
                    ...
                    <div class="row justify-content-center row-space no-print">
                        <div class="col-12 col-md-4 col-lg-3 no-print">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        Buscar de Atendimentos
                                    </div>
                                    <input type="text" placeholder="00/00/0000" v-model="DataAtendimentoBuscar" v-on:keyup="buscarDataAtendimento()" v-mask="'##/##/####'" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-lg-3  text-center no-print">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h5> Tipo de atendimento</h5>
                                    </div>
                                    <h5 class="card-title text-primary" v-if="parametros.tipo_atendimento == 'todos'">Todos</h5>
                                    <h5 class="card-title text-primary" v-else>{{parametros.tipo_atendimento}}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-lg-3  no-print text-center">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h5> Lista de atendimento</h5>
                                    </div>
